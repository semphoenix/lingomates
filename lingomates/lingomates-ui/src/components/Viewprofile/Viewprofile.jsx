              ...
              <Grid item sx={{ width: 450 }}>
                <Card sx={{ minHeight: 600 }}>
                  ...
                  <CardContent>
                    <Typography
                      align="center"
                      sx={{ paddingTop: 2, fontSize: "2.5rem" }}
                    >
                    ...
                    >
                      Native Language: {selectedUser.nativelanguage}
                    </Typography>
                    {selectedUserLangs?.map((selectedLangs) => {
                      return (
                        <Typography
                          align="center"
                          sx={{ paddingTop: 2.5, fontSize: "1.5rem" }}
                        >
                          {selectedLangs.linguaname}
                          <span className="last-name">
                            {selectedLangs.proficiencylevel}
                          </span>
                        </Typography>
                      );
                    })}
                    ...
                    >
                      <Button
                        onClick={() => handleSendMessage(chosenUserId.id)}
                        variant="outlined"
                        size="medium"
                      >
                        Message
