    ...
    <ThemeProvider theme={defaultTheme}>
      ...
      <Grid container component="main" sx={{ height: '100vh'}}>
        ...
        <Grid
          ...
          md={7}
          sx={{
            backgroundImage: 'url(https://img.myloview.com/posters/young-happy-people-laughing-together-multiracial-friends-group-having-fun-on-city-street-diverse-culture-students-portrait-celebrating-outside-friendship-community-youth-university-concept-700-268008224.jpg)',
